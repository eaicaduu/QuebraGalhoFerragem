window.abrirCadastroSwal = function () {
    Swal.fire({
        html: `
            ...
            <form id="cadastroForm" class="d-flex flex-column align-items-center px-4 text-dark" style="max-width:400px; margin:auto; border-radius:12px;">
                ...
                <div class="mb-3 w-100">
                    ...
                    <input type="email" id="emailCadastro" class="form-control rounded-4" placeholder="Informe seu email" autocomplete="email">
                </div>

                <label for="senhaCadastro" class="form-label">Senha</label>
                <div class="mb-3 w-100 position-relative">
                    <input type="password" id="senhaCadastro" class="form-control rounded-4" placeholder="Informe sua senha" style="padding-right:40px;" autocomplete="new-password">
        ...
        didOpen: () => {
            ...
            const toggleSenhaCadastro = popup.querySelector('#toggleSenhaCadastro');
            const senhaCadastroInput = popup.querySelector('#senhaCadastro');
            ...
            const btnCadastrar = popup.querySelector('#btnCadastrar');
            const inputs = popup.querySelectorAll('#nome, #emailCadastro, #senhaCadastro');
