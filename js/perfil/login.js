        ...
        html: `
            ...
            <form id="loginForm" class="d-flex flex-column align-items-center px-4 text-dark" style="max-width:400px; margin:auto; border-radius:12px;">
                <div class="mb-3 w-100">
                    ...
                    <input type="email" id="email" class="form-control rounded-4" placeholder="Informe o seu email" autocomplete="email">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3 w-100 position-relative">
                <input type="password" id="senha" class="form-control rounded-4" placeholder="Informe a sua senha" style="padding-right:40px;" autocomplete="current-password">
...
window.semCadastroSwal = function () {
    Swal.fire({
        html: `
            <div style="text-align:center;">
                <i class="fa fa-tools mb-3" style="font-size:40px; color:#6c757d;"></i>
                <h5 class="mb-2">Funcionalidade em desenvolvimento</h5>
                <div class="text-muted">
                    O sistema ainda não permite cadastros.
                </div>
            </div>
        `,
